...
@section('title', '| Percetakan Medali Sekolah')

@section('content')
    <section class="py-16 bg-gray-100">
        <div class="container px-4 mx-auto text-center">
            <h2 class="mb-12 text-3xl font-bold">Pilih Paket Medali Sekolah</h2>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                @forelse($paketMedaliSekolah as $paket)
                    <div
                ...
                @empty
                    <div class="py-10 text-center text-gray-600 col-span-full">
                        Belum ada paket Paket Medali Sekolah yang tersedia saat ini.
                    </div>
                @endforelse
            </div>
        </div>
