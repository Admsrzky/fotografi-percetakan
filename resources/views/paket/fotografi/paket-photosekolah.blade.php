...
@section('title', '| Photo Sekolah Photography')

@section('content')
    <section class="py-16 bg-gray-100">
        <div class="container px-4 mx-auto text-center">
            <h2 class="mb-12 text-3xl font-bold">Pilih Paket Photo Sekolah Impian Anda</h2>
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                @empty
                    <div class="py-10 text-center text-gray-600 col-span-full">
                        Belum ada paket Photo Sekolah yang tersedia saat ini.
                    </div>
                @endforelse
            </div>
        </div>
