...
@section('title', 'Profil Pengguna - Re Project')
@section('description', 'Kelola informasi profil dan kata sandi Anda di Re Project.')
@section('keywords', 'profil, akun, kata sandi, Faa Roti')


@section('content')
    <div class="container px-4 py-12 mx-auto lg:px-8"> {{-- Hapus mt-24 karena sudah ada py-6 di page-header --}}
