<header class="sticky top-0 z-50 py-4 bg-white shadow-md">
    <nav class="container flex items-center justify-between px-4 mx-auto">
        ...
        <ul class="hidden space-x-6 md:flex">
            ...
            <li class="relative" x-data="{ open: false }">
                ...
                <ul x-show="open" @click.outside="open = false"
                    ...
                    class="absolute z-50 w-48 py-2 mt-2 bg-white rounded-md shadow-lg">
                    <li><a href="{{ url('/pakets-wedding') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Photo
                            Wedding</a>
                    </li>
                    ...
                    <li><a href="{{ url('/pakets-all-event') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Photo All
                            Event</a>
                    </li>
                    <li><a href="{{ url('/pakets-vidioCinematic') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Vidio
                            Cinematic</a>
                    </li>
                    <li><a href="{{ url('/pakets-vidioLiputan') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Vidio Liputan
                            All Event</a>
                    </li>
                </ul>
            </li>
            <li class="relative" x-data="{ open: false }">
                ...
                <ul x-show="open" @click.outside="open = false"
                    ...
                    <li><a href="{{ url('/pakets-cetakIdCard') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Cetak ID
                            Card</a>
                    </li>
                    <li><a href="{{ url('/pakets-cetakFoto') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Cetak Foto
                            All Size</a>
                    </li>
                    <li><a href="{{ url('/pakets-cetakMIR') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Map Ijazah
                            dan Raport</a>
                    </li>
                    <li><a href="{{ url('/pakets-medaliSekolah') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Medali
                            Sekolah</a>
                    </li>
                    <li><a href="{{ url('/pakets-cetakJenisBuku') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Cetak Jenis
                            Buku</a>
                    </li>
                    <li><a href="{{ url('/pakets-cetakStikerLabel') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Cetak Stiker
                            Label Kemasan</a>
                    </li>
                    <li><a href="{{ url('/pakets-cetakKalender') }}"
                            class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Cetak
                            Kalender</a>
                    </li>
        ...
        <div class="flex items-center space-x-4">
            {{-- Bagian Tampilan Desktop Saja --}}
            <div class="items-center hidden space-x-4 md:flex">
                @auth {{-- Tampilkan ini jika pengguna sudah login --}}
                <a href="{{ route('pemesanan.form') }}"
                    class="px-6 py-2 font-semibold text-white transition duration-300 rounded-full shadow-md bg-accent hover:bg-accent-dark">
                    Pesan Sekarang
                </a>
                ...
                @else
                <a href="{{ route('login') }}"
                    class="px-6 py-2 font-semibold text-gray-700 transition duration-300 rounded-full bg-slate-100 hover:text-accent">
                    Login
                </a>
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            x-transition:leave-end="opacity-0 scale-95" class="py-2 mt-2 space-y-1 bg-white rounded-md">
                            <li><a href="{{ url('/pakets-wedding') }}"
                                    class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Photo
                                    Wedding</a>
                            </li>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <ul x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <li><a href="{{ url('/pakets-cetakMIR') }}"
                                    class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Map
                                    Ijazah dan Raport</a>
                            </li>
                            <li><a href="{{ url('/pakets-medaliSekolah') }}"
                                    class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Medali
                            ...
                            <li><a href="{{ url('/pakets-bingkaiFoto') }}"
                                    class="block px-4 py-2 text-gray-700 transition duration-300 hover:bg-gray-100">Bingkai
                                    Foto All Size</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    {{-- Bagian Akun Saya (Mobile) --}}
                    <div class="pt-4 mt-4 border-t border-gray-200">
                        @auth
                        <h4 class="mb-2 font-semibold text-gray-500">Akun Saya</h4>
                        <a href="{{ route('profile.show') }}" class="block px-2 py-1 text-gray-700 hover:bg-gray-100">Edit
                            Profile</a>
                        <a href="" class="block px-2 py-1 text-gray-700 hover:bg-gray-100">Riwayat
                            Pesanan</a>
                        <a href="{{ route('logout') }}"
